...
package. See xref:working-with-spec-files[] for details.
...
demonstrates when the source code does not need to be built, but only needs to be
...
xref:advanced-topics[Advanced Topics], under the xref:more-on-macros[More on Macros] section, and are
